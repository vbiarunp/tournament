$(document).ready(function() {
    ...
    for (var i in data[0]) {
        ...
        parentContainer.append('text').attr("x", 15).attr("y", transitY + 17).attr("class", "teamtext").text(data[0][i][0].team1);
        ...
        parentContainer.append('text').attr("x", 15).attr("y", transitY + 43).attr("class", "teamtext").text(data[0][i][0].team2);

        parentContainer.append('rect').attr("width", "3%").attr("height", "25px").attr("x", '12%').attr("y", transitY).style("fill", "#ff7324").style("stroke", "white").style("stroke-width", "1");
        parentContainer.append('rect').attr("width", "3%").attr("height", "25px").attr("x", '12%').attr("y", transitY + 25).style("fill", "#64656d").style("stroke", "white").style("stroke-width", "1");
        number += 1;
        parentContainer.append('text').attr("x", "13%").attr("y", transitY + 17).attr("class", "teamNumber").text(number);
        number += 1;
        parentContainer.append('text').attr("x", "13%").attr("y", transitY + 43).attr("class", "teamNumber").text(number);

        parentContainer.append("line")          // attach a line
                        .style("stroke", "white")  // colour the line
                        .attr("x1", 190)     // x position of the first end of the line
                        .attr("y1", transitY + 25)      // y position of the first end of the line
